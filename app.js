...
const restaurantDatabase = [
    ...
    { name: "小蒙牛頂級麻辣養生鍋", cuisine: "火鍋", lat: 24.0749, lng: 120.5428, time: ["lunch", "dinner"], rating: 4.1, reviews: 1400, address: "彰化市中正路二段70號" },
    ...
    { name: "八色烤肉 mini (彰化店)", cuisine: "燒肉", lat: 24.0748, lng: 120.5361, time: ["lunch", "dinner"], rating: 4.3, reviews: 410, address: "彰化市曉陽路201號" },
    ...
    { name: "喜樂珍素食拉麵", cuisine: "拉麵", lat: 24.0739, lng: 120.5422, time: ["lunch", "dinner"], rating: 4.5, reviews: 310, address: "彰化市華山路135號" },
    { name: "敏敏日式食堂", cuisine: "日式", lat: 24.0771, lng: 120.5381, time: ["lunch", "dinner"], rating: 4.3, reviews: 320, address: "彰化市永安街235號" },
    { name: "爭鮮旋轉壽司 (彰化店)", cuisine: "日式", lat: 24.0742, lng: 120.5411, time: ["lunch", "dinner"], rating: 4.0, reviews: 1800, address: "彰化市中正路二段177號" },
    ...
    { name: "和屋日式料理", cuisine: "日式", lat: 24.0711, lng: 120.5461, time: ["lunch", "dinner"], rating: 4.2, reviews: 490, address: "彰化市南郭路一段" },
    { name: "定食8 (彰化店)", cuisine: "日式", lat: 24.0906, lng: 120.5346, time: ["lunch", "dinner"], rating: 3.9, reviews: 920, address: "彰化市金馬路二段321號1樓" },
    ...
    { name: "米內瓦之家 (義式簡餐)", cuisine: "義大利麵", lat: 24.0751, lng: 120.5458, time: ["lunch", "dinner"], rating: 4.4, reviews: 430, address: "彰化市中山路二段" },
    { name: "古拉爵義式屋 (彰化家樂福店)", cuisine: "義大利麵", lat: 24.0901, lng: 120.5342, time: ["lunch", "dinner"], rating: 4.1, reviews: 1400, address: "彰化市金馬路二段321號" },
    { name: "街角廚房", cuisine: "義大利麵", lat: 24.0699, lng: 120.5471, time: ["lunch", "dinner"], rating: 4.2, reviews: 360, address: "彰化市南郭路一段" },
    { name: "咖哩盒子", cuisine: "便當", lat: 24.0722, lng: 120.5352, time: ["lunch", "dinner"], rating: 4.3, reviews: 290, address: "彰化市大埔路" },
    { name: "品田牧場 (彰化中正店)", cuisine: "日式", lat: 24.0801, lng: 120.5392, time: ["lunch", "dinner"], rating: 4.4, reviews: 1900, address: "彰化市中正路二段175號" },
    { name: "Skinny Cafe 瘦子咖啡", cuisine: "簡餐", lat: 24.0805, lng: 120.5418, time: ["lunch"], rating: 4.6, reviews: 680, address: "彰化市光復路143號" },
    { name: "端倪生活 (老宅簡餐甜點)", cuisine: "簡餐", lat: 24.0819, lng: 120.5391, time: ["lunch"], rating: 4.3, reviews: 1100, address: "彰化市三民路9號" },
    { name: "摩斯漢堡 (彰化中正店)", cuisine: "美式", lat: 24.0772, lng: 120.5415, time: ["lunch", "dinner"], rating: 4.1, reviews: 850, address: "彰化市中正路二段" },
    ...
    { name: "肯德基 (彰化曉陽店)", cuisine: "美式", lat: 24.0732, lng: 120.5369, time: ["lunch", "dinner"], rating: 3.8, reviews: 1700, address: "彰化市曉陽路" },

    // ═══════════════════════════════════════
    // 🍱 彰化日常激戰區：大埔路/南郭路便當、水餃、牛肉麵
    // ═══════════════════════════════════════
    ...
    { name: "金之園排骨便當", cuisine: "便當", lat: 24.0689, lng: 120.5348, time: ["lunch", "dinner"], rating: 4.2, reviews: 390, address: "彰化市大埔路" },
    { name: "桌上賓便當 (彰化大埔店)", cuisine: "便當", lat: 24.0665, lng: 120.5338, time: ["lunch", "dinner"], rating: 4.0, reviews: 450, address: "彰化市大埔路602號" },
    { name: "原味南郭部隊鍋便當", cuisine: "便當", lat: 24.0688, lng: 120.5461, time: ["lunch", "dinner"], rating: 4.0, reviews: 190, address: "彰化市南郭路一段161號" },
    { name: "彰化五信水餃", cuisine: "餃子", lat: 24.0792, lng: 120.5402, time: ["dinner", "midnight"], rating: 4.2, reviews: 800, address: "彰化市華山路38號" },
    { name: "五花馬水餃館 (彰化店)", cuisine: "餃子", lat: 24.0768, lng: 120.5341, time: ["lunch", "dinner"], rating: 3.9, reviews: 1100, address: "彰化市曉陽路" },
    { name: "香饌胡椒餅", cuisine: "便當", lat: 24.0732, lng: 120.5431, time: ["lunch"], rating: 4.5, reviews: 600, address: "彰化市成功路" },
    ...
    { name: "大埔專業牛肉麵", cuisine: "牛肉麵", lat: 24.0701, lng: 120.5340, time: ["lunch", "dinner"], rating: 4.0, reviews: 320, address: "彰化市大埔路" },
    ...
    { name: "丐幫滷味 (彰化總店)", cuisine: "宵夜", lat: 24.0779, lng: 120.5392, time: ["dinner", "midnight"], rating: 3.9, reviews: 640, address: "彰化市中正路二段" },
    { name: "三民路無名碳烤", cuisine: "宵夜", lat: 24.0825, lng: 120.5398, time: ["midnight"], rating: 4.3, reviews: 250, address: "彰化市三民路" },
    { name: "港式阿國滷味 (精誠夜市店)", cuisine: "宵夜", lat: 24.0691, lng: 120.5185, time: ["midnight"], rating: 4.5, reviews: 900, address: "彰化市林森路162號 (精誠夜市內)" },
    { name: "旺角黑糖排骨 (精誠夜市店)", cuisine: "宵夜", lat: 24.0692, lng: 120.5186, time: ["midnight"], rating: 4.2, reviews: 410, address: "彰化市精誠夜市" },
    ...
    { name: "大元蔴薯 (鹹麻糬)", cuisine: "甜點", lat: 24.0781, lng: 120.5448, time: ["lunch", "dinner"], rating: 4.4, reviews: 3800, address: "彰市民生路42巷14號" },
    { name: "不二坊蛋黃酥", cuisine: "甜點", lat: 24.0811, lng: 120.5462, time: ["lunch", "dinner"], rating: 4.1, reviews: 8200, address: "彰化市中正路一段293號" },
    { name: "寶珍香桂圓蛋糕", cuisine: "甜點", lat: 24.1031, lng: 120.5684, time: ["lunch", "dinner"], rating: 4.3, reviews: 2900, address: "彰化市彰南路二段165號" },
    { name: "成功路阿婆芋圓", cuisine: "甜點", lat: 24.0799, lng: 120.5415, time: ["lunch"], rating: 4.6, reviews: 1300, address: "彰化市成功路" },
    { name: "糯米炸 (民生店)", cuisine: "甜點", lat: 24.0788, lng: 120.5439, time: ["lunch", "dinner"], rating: 4.4, reviews: 950, address: "彰化市民生路" }
];

// 自動生成另外 100 多家日常小型餐廳、飲料店與攤販，保證全彰化市全類型制霸
...
for (let i = 1; i <= 105; i++) {
    ...
    // 圍繞彰化火車站中心 (24.0814, 120.5383) 亂數產生小店家經緯度 (方圓 3 公里內)
...
function filterRestaurants(userLocation) {
    ...
    if (filteredList.length === 0) {
        resultsContainer.innerHTML = `
            <div class="no-result">
                ❌ 抱歉！目前彰化市內沒有符合您所有條件的餐廳。<br>
                <span style="font-size:14px; font-weight:normal; color:#aaa;">建議您可以放大距離（如選不限距離）或換個時段試試看喔！</span>
            </div>
        `;
        return;
    }
